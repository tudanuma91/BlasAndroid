...
class Test2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var Button = view.findViewById<Button>(com.v3.basis.blas.R.id.button)
        Button.setOnClickListener{
            ...
            try {
                db.insertOrThrow("QueueTable", null, values)
                Log.d("【insert】", "成功")
        ...
        var selectBtn = view.findViewById<Button>(com.v3.basis.blas.R.id.select)
        selectBtn.setOnClickListener{
            Log.d("【DBセレクト】", "開始")
            val sql = "select * from QueueTable"
